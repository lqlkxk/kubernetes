...
192.168.56.104   Ready     <none>    9m        v1.9.0
192.168.56.105   Ready     <none>    9m        v1.9.0 
kubectl get pods
...
**官方示例**
   ...
   **访问**
   测试方式
   kubectl proxy 
   curl 127.0.0.1:8001/api/v1/proxy/namespaces/default/pods/kubernates-.../
   **扩缩容**
